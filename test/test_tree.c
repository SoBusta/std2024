...
void insert_search_extra()
{
    Tree *tree = tree_create();
    tree_insert(tree, (void *)5, int_cmp);
    tree_insert(tree, (void *)3, int_cmp);
    tree_insert(tree, (void *)8, int_cmp);
    tree_insert(tree, (void *)1, int_cmp);
    tree_insert(tree, (void *)4, int_cmp);
    tree_insert(tree, (void *)7, int_cmp);
    tree_insert(tree, (void *)9, int_cmp);
    ...
    node = tree_search(tree, (void *)11, int_cmp);
    TEST_ASSERT_(node == NULL, "Node is not NULL");
    tree_destroy(tree);
}
...
TEST_LIST = {
    ...
    {"bfs", bfs},
    {"dfs", dfs},
    {"insert_search_extra", insert_search_extra},
    {"bfs_extra", bfs_extra},
    {"dfs_extra", dfs_extra},
    {NULL, NULL}};
