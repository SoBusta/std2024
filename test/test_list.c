...
void contains(){
    ...
    list_append(list, (void*)2);
    list_append(list, (void*)3);
    TEST_ASSERT_(list_contains(list, (void*)1) == 1, "List contains 1 failed 1");
    TEST_ASSERT_(list_contains(list, (void*)2) == 1, "List contains 2 failed 2");
    TEST_ASSERT_(list_contains(list, (void*)3) == 1, "List contains 3 failed 3");
    list_delete(list, 0);
    TEST_ASSERT_(list_contains(list, (void*)1) == 0, "List contains 1 failed 4");
    list_delete(list, 1);
    TEST_ASSERT_(list_contains(list, (void*)2) == 1, "List contains 2 failed 5");
    TEST_ASSERT_(list_contains(list, (void*)3) == 0, "List contains 3 failed 6");
    list_delete(list, 0);
    TEST_ASSERT_(list_contains(list, (void*)2) == 0, "List contains 2 failed 7");
}
